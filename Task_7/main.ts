...
console.log("2 + 6 Addition = ", 2 + 6); //Addition
console.log("10 - 2 Subtraction = ", 10 - 2); //Subtraction
console.log("4 * 2 Multiplication = ", 4 * 2); //Multiplication
console.log("16 / 2 Division = ", 16 / 2); //Division
